...
static const struct MetaClassDescription descriptions[META_CLASS_DESCRIPTIONS_COUNT] = {
    ...
    {0x02C723D77F0C4B32, "Handle<AudioData>", intrinsic8Read, renderSymbol},
    ...
    {0x07A995E0FEEEDA3E, "Handle<ResourceBundle>", intrinsic8Read, renderSymbol},
    ...
    {0x0AD7EF65B5C2FB8B, "Handle<StyleIdleTransitionsRes>", intrinsic8Read, renderSymbol},
    {0x0B350ED3E60A3A82, "Handle<LightProbeData>", intrinsic8Read, renderSymbol},
    {0x0B47B28F9B66367C, "CompressedKeys<Handle<Dlg>>", NULL, NULL},
    {0x0B8BD6449DCB3262, "Map<int,Ptr<DialogText>,less<int>>", NULL, NULL},
    {0x0BA8280CE6EE5023, "Handle<BlendMode>", intrinsic8Read, renderSymbol},
    ...
    {0x101E4BF52A9999AC, "long", intrinsic4Read, renderInt4},
    ...
    {0x12CD3F0920AE1380, "Handle<LanguageDatabase>", intrinsic8Read, renderSymbol},
    ...
    {0x177AAECBE81EC7CF, "Handle<SoundEventData>", intrinsic8Read, renderSymbol},
    ...
    {0x1B3355ECACF8ED7C, "Handle<Dlg>", intrinsic8Read, renderSymbol},
    ...
    {0x1CA3A30A80E58244, "Handle<ParticleSprite>", intrinsic8Read, renderSymbol},
    {0x1CCDC5D367F7A6B7, "Handle<T3OverlayData>", intrinsic8Read, renderSymbol},
    ...
    {0x28B6294866D5C910, "Handle<TransitionMap>", intrinsic8Read, renderSymbol},
    ...
    {0x3057C880E751D8C5, "Handle<Animation>", intrinsic8Read, renderSymbol},
    ...
    {0x37B8C02CC0B488BE, "Handle<EventStorage>", intrinsic8Read, renderSymbol},
    {0x383AEB196C60831B, "LocationInfo", NULL, NULL},
    {0x387E6B9CA558AC8D, "Handle<PropertySet>", intrinsic8Read, renderSymbol},
    {0x394C43AF4FF52C94, "Vector3", Vector3Read, renderVector3},
    ...
    {0x3F9231D57F64F520, "Handle<Font>", intrinsic8Read, renderSymbol},
    ...
    {0x46DE57E6E6C4DF4A, "Handle<SaveGame>", intrinsic8Read, renderSymbol},
    {0x471A8A4511F0CCA6, "Handle<WalkBoxes>", intrinsic8Read, renderSymbol},
    ...
    {0x48588668F74FED9F, "UID::Owner", intrinsic4Read, renderInt4},
    ...
    {0x4BD04E27E6716EA0, "UID::Generator", intrinsic4Read, renderInt4},
    ...
    {0x4FC0A74CE6DAD33E, "Handle<LocomotionDB>", intrinsic8Read, renderSymbol},
    ...
    {0x52A09151F1C3F2C7, "Handle<T3Texture>", intrinsic8Read, renderSymbol},
    ...
    {0x5896A6FD1866FD93, "Handle<Rules>", intrinsic8Read, renderSymbol},
    ...
    {0x61D00957E63D7435, "Handle<VoiceData>", intrinsic8Read, renderSymbol},
    {0x620211ED1DF8D233, "CompressedKeys<Transform>", NULL, NULL},
    {0x62045DC19ADEF8FB, "Handle<ParticleProperties>", intrinsic8Read, renderSymbol},
    ...
    {0x6643AF6DCCCC81A9, "Handle<Chore>", intrinsic8Read, renderSymbol},
    ...
    {0x673D6BC4E630EA46, "Handle<PhonemeTable>", intrinsic8Read, renderSymbol},
    {0x67600F19A2762290, "EnumMeshDebugRenderType", NULL, NULL},
    {0x681AF06EDA9AF05D, "DlgChildSetChoicesChildPost", NULL, NULL},
    {0x68CD2023740B9FB6, "Handle<SoundEventSnapshotData>", intrinsic8Read, renderSymbol},
    ...
    {0x6F727FA52828A910, "Handle<SoundReverbDefinition>", intrinsic8Read, renderSymbol},
    ...
    {0x73E09E0F84717F0A, "Handle<D3DMesh>", intrinsic8Read, renderSymbol},
    {0x73E6A067ABDBD2D9, "ScriptEnum:BlendTypes", ScriptEnumRead, NULL},
    {0x746B85A804E2AE3A, "Handle<ResourceGroupInfo>", intrinsic8Read, renderSymbol},
    ...
    {0x7CBA2F7647F0AE16, "Handle<Rule>", intrinsic8Read, renderSymbol},
    {0x7CF961832ED64527, "KeyframedValue<Vector4>", NULL, NULL},
    {0x7D0AE6CA0E07BD29, "DArray<bool>", NULL, NULL},
    {0x7D5B490DEF40D9C2, "Handle<AnimOrChore>", intrinsic8Read, renderSymbol},
    ...
    {0x823DB9F90B846250, "Handle<Skeleton>", intrinsic8Read, renderSymbol},
    ...
    {0x83AFDE994EFEA3D9, "Handle<ActorAgentMapper>", intrinsic8Read, renderSymbol},
    {0x83F92DB3ED618AC1, "DCArray<PreloadPackage::ResourceKey>", NULL, NULL},
    {0x84283CB979D71641, "Flags", intrinsic4Read, renderInt4},
    ...
    {0x8758F70880295F9B, "Handle<SoundAmbience::AmbienceDefinition>", intrinsic8Read, renderSymbol},
    {0x878A3470E047E140, "Map<int,Ptr<DialogDialog>,less<int>>", NULL, NULL},
    {0x87B6B95067DB12F9, "DlgChildSetConditionalCase", NULL, NULL},
    {0x87E0E880D7D2DFC1, "DlgObjID", intrinsic8Read, renderSymbol},
    ...
    {0x8ACE27FDA34B2606, "Handle<SoundBusSnapshot::SnapshotSuite>", intrinsic8Read, renderSymbol},
    ...
    {0x9004C5587575D6C0, "bool", BoolRead, renderBool},
    ...
    {0x9395A07A617964C9, "Handle<StyleGuide>", intrinsic8Read, renderSymbol},
    ...
    {0x96214C23CC241657, "Handle<StyleGuideRef>", intrinsic8Read, renderSymbol},
    ...
    {0x99D7C52EA7F0F97D, "int", intrinsic4Read, renderInt4},
    ...
    {0x9EE5E31EF2F71F0E, "Handle<Scene>", intrinsic8Read, renderSymbol},
    ...
    {0xA14B12F2880C71F0, "Handle<PreloadPackage::RuntimeDataDialog>", intrinsic8Read, renderSymbol},
    ...
    {0xA47918A7D3C3A67A, "Handle<PhysicsObject>", intrinsic8Read, renderSymbol},
    ...
    {0xABD836B706872262, "Handle<DialogResource>", intrinsic8Read, renderSymbol},
    ...
    {0xB930FF00A4687C7E, "Handle<InputMapper>", intrinsic8Read, renderSymbol},
    ...
    {0xBABC2FCF7E7B70AA, "Style", NULL, NULL},
    {0xBAE4CBD77F139A91, "float", intrinsic4Read, renderFloat},
    ...
    {0xC07A4D6DA8CD0B6C, "Handle<BlendGraphManager>", intrinsic8Read, renderSymbol},
    {0xC09A0F1FEE902C1A, "CSPK2Context", NULL, NULL},
    {0xC0B682D7D515ED83, "Handle<SoundEventBankDummy>", intrinsic8Read, renderSymbol},
    {0xC0E90B6129B2DADA, "CompressedKeys<bool>", NULL, NULL},
    {0xC16762F7763D62AB, "Color", ColorRead, renderColor},
    {0xC1E4AC327DAD6D1C, "bgh", NULL, NULL},
    {0xC2254DAAD52E7340, "Handle<PhysicsData>", intrinsic8Read, renderSymbol},
    {0xC23697BBFB06DD17, "Handle<LanguageResource>", intrinsic8Read, renderSymbol},
    ...
    {0xC61768F8C7376559, "Handle<SoundBusSnapshot::Snapshot>", intrinsic8Read, renderSymbol},
    ...
    {0xCB029403B12D08D6, "unsignedint", intrinsic4Read, renderInt4},
    ...
    {0xCD9C6E605F5AF4B4, "String", StringRead, renderString},
    {0xCDA6183D330B433B, "ChoreInst", NULL, NULL},
    {0xCDD094E2E769C2B5, "ToolProps", BoolRead, renderBool},
    ...
    {0xD5C86012BF6B91CA, "LanguageResProxy", intrinsic4Read, renderInt4},
    ...
    {0xDC03A83314ADFC51, "Handle<BlendGraph>", intrinsic8Read, renderSymbol},
    ...
    {0xDF2C74713A04DDA7, "Handle<SoundData>", intrinsic8Read, renderSymbol},
    {0xDF302FFF123E7CAB, "T3MaterialParameter", NULL, NULL},
    {0xDF30362E292BEF14, "CompressedKeys<Color>", NULL, NULL},
    {0xDFA5071C13D73E63, "Handle<AgentMap>", intrinsic8Read, renderSymbol},
    ...
    {0xEB7FE6D415249768, "Handle<PreloadPackage::RuntimeDataScene>", intrinsic8Read, renderSymbol},
    ...
    {0xFC96DFDEDE31FB4A, "unsignedlong", intrinsic4Read, renderInt4},
