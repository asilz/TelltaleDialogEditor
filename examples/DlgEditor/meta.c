...
static const struct MetaClassDescription descriptions[] = {
    {0x004F023463D89FB0, "Symbol", intrinsic8Read, SymbolRender},
    ...
    {0x026495DD43D2BE66, "KeyframedValue<Handle<Chore>>", KeyframedValue_Handle_Chore__Read, NULL},
    {0x02A9ACE31B9DB46D, "DCArray<KeyframedValue<Color>::Sample>", NULL, NULL},
    {0x02C723D77F0C4B32, "Handle<AudioData>", intrinsic8Read, SymbolRender},
    ...
    {0x046D4F1EB16A8ABF, "AnimatedValueInterface<Handle<T3Texture>>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x06D503EAE2AF659D, "List<ActingPaletteGroup::ActingPaletteTransition>", List_ActingPaletteGroup__ActingPaletteTransition_Read, NULL},
    {0x07053D1D5732E4D5, "ScriptEnum:QTE_Type", ScriptEnumRead, NULL},
    {0x0760518169BE7C9C, "FootSteps::FootstepBank", Footsteps__FootstepBankRead, NULL},
    {0x07A995E0FEEEDA3E, "Handle<ResourceBundle>", intrinsic8Read, SymbolRender},
    ...
    {0x0A034C9344F17FCE, "KeyframedValue<ScriptEnum>", KeyframedValue_ScriptEnum_Read, NULL},
    {0x0A09E83894C80579, "Map<String,Handle<PropertySet>,less<String>>", NULL, NULL},
    {0x0AD7EF65B5C2FB8B, "Handle<StyleIdleTransitionsRes>", intrinsic8Read, SymbolRender},
    {0x0B350ED3E60A3A82, "Handle<LightProbeData>", intrinsic8Read, SymbolRender},
    {0x0B47B28F9B66367C, "CompressedKeys<Handle<Dlg>>", NULL, NULL},
    {0x0B8BD6449DCB3262, "Map<int,Ptr<DialogText>,less<int>>", NULL, NULL},
    {0x0BA8280CE6EE5023, "Handle<BlendMode>", intrinsic8Read, SymbolRender},
    ...
    {0x0CBCC5585D066C26, "DCArray<KeyframedValue<Handle<Font>>::Sample>", DCArray_KeyframedValue_Handle_Font____Sample_Read, NULL},
    ...
    {0x0EE94831CBA42B32, "DCArray<KeyframedValue<Vector2>::Sample>", DCArray_KeyframedValue_Vector2___Sample_Read, NULL},
    {0x0F43F2EB7185E296, "DCArray<Ptr<ActingPaletteClass>>", DCArray_ActingPaletteClass_Read, NULL},
    {0x0FA0200E101BA5B8, "Map<Symbol,PreloadPackage::ResourceSeenTimes,less<Symbol>>", NULL, NULL},
    {0x0FDC0365EABBD69E, "NavCam::EnumMode", intrinsic4Read, NULL},
    {0x1019453EB19C1ABD, "KeyframedValue<Quaternion>", KeyframedValue_Quaternion_Read, NULL},
    {0x101E4BF52A9999AC, "long", intrinsic4Read, s32Render},
    {0x106930CCC0A67F81, "DCArray<Guide>", NULL, NULL},
    {0x108A4BDBA5C4323C, "CompressedKeys<Vector3>", NULL, NULL},
    {0x11044749232970C0, "uint64", intrinsic8Read, u64Render},
    ...
    {0x12CD3F0920AE1380, "Handle<LanguageDatabase>", intrinsic8Read, SymbolRender},
    {0x13058734F0A0B42F, "DCArray<Handle<Chore>>", DCArray_Handle_Chore__Read, NULL},
    {0x135C8F048CAB3B1A, "DCArray<T3MeshMaterialOverride>", DCArray_T3MeshMaterialOverride_Read, NULL},
    {0x13701CC75D2E8F76, "KeyframedValue<Handle<SoundData>>", KeyframedValue_Handle_SoundData__Read, NULL},
    {0x1373B90F4631D050, "GFXPlatformAttributeParams", GFXPlatformAttributeParamsRead, GFXPlatformAttributeParamsRender},
    ...
    {0x14E382987D757E47, "KeyframedValue<Symbol>", KeyframedValue_Symbol_Read, NULL},
    {0x15623933D3FDB46F, "EnlightenModule::EnumeBackfaceType", intrinsic4Read, NULL},
    {0x169DBBF7BC9DAE98, "preloadpackagerts", NULL, NULL},
    {0x16F70EA63ACE4D1F, "SoundData", NULL, NULL},
    {0x177AAECBE81EC7CF, "Handle<SoundEventData>", intrinsic8Read, SymbolRender},
    {0x178C1A035ED26487, "IdleSlotDefaults", NULL, NULL},
    {0x1793F7CC87414A9C, "DCArray<T3MaterialNestedMaterial>", DCArray_T3MaterialNestedMaterial_Read, NULL},
    {0x17A22BCB7F71DA7C, "AnimatedValueInterface<Handle<SoundBusSnapshot::Snapshot>>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x18B7A88B80875CBE, "PhonemeTable", PhonemeTableRead, NULL},
    {0x18F3EC40E3993F23, "DCArray<KeyframedValue<Handle<Chore>>::Sample>", DCArray_KeyframedValue_Handle_Chore____Sample_Read, NULL},
    {0x193947C951B51053, "CompressedVertexPositionKeys", NULL, NULL},
    {0x1966C52FAEA296B5, "AnimatedValueInterface<Handle<SoundAmbience::AmbienceDefinition>>", AnimatedValueInterfaceGenericRead, NULL},
    {0x196A1BF777E8C2F8, "ActingPaletteGroup::EnumIdleTransition", intrinsic4Read, NULL},
    {0x19F654ED32A2C708, "EnumT3MaterialLODFullyRough", intrinsic4Read, NULL},
    {0x1AFF8E5E688E0117, "EnlightenModule::EnumeSimplifyMode", intrinsic4Read, NULL},
    {0x1B3355ECACF8ED7C, "Handle<Dlg>", intrinsic8Read, SymbolRender},
    {0x1B3A715D9339AF5F, "CompressedKeys<Handle<T3Texture>>", NULL, NULL},
    {0x1BBD9C16A1D7261C, "unsignedshort", intrinsic2Read, u16Render},
    ...
    {0x1C085FBA0B240337, "DCArray<T3MeshEffectPreload>", DCArray_T3MeshEffectPreload_Read, NULL},
    {0x1C7C457A2166B727, "EnumRenderMaskTest", intrinsic4Read, NULL},
    {0x1CA3A30A80E58244, "Handle<ParticleSprite>", intrinsic8Read, SymbolRender},
    {0x1CCDC5D367F7A6B7, "Handle<T3OverlayData>", intrinsic8Read, SymbolRender},
    {0x1CF4C103D0290F37, "unsignedchar", intrinsic1Read, u8Render},
    ...
    {0x1DDC6104AA9DFDC0, "DCArray<T3MaterialPreShader>", DCArray_T3MaterialPreShader_Read, NULL},
    {0x1DF7C31EA25EAE57, "KeyframedValue<Handle<SoundBusSnapshot::SnapshotSuite>>", KeyframedValue_Handle_SoundBusSnapshot__SnapshotSuite__Read, NULL},
    {0x1E0A2AD219F12B54, "DCArray<KeyframedValue<SoundEventName<0>>::Sample>", DCArray_KeyframedValue_SoundEventName_0____Sample_Read, NULL},
    {0x1E66E396A35F93F9, "ScriptEnum:MenuVerticalAlignment", ScriptEnumRead, NULL},
    {0x1E7032DDDA683211, "DCArray<T3MeshEffectPreloadDynamicFeatures>", DCArray_T3MeshEffectPreloadDynamicFeatures_Read, NULL},
    {0x1E89F50D0F33E645, "FileNameBase", intrinsic8Read, NULL},
    {0x1EEF71B2306B5B6C, "uint16", intrinsic2Read, NULL},
    {0x1EF9BD7B68F3F685, "DCArray<KeyframedValue<Handle<SoundBusSnapshot::Snapshot>>::Sample>", DCArray_KeyframedValue_Handle_SoundBusSnapshot__Snapshot____Sample_Read, NULL},
    ...
    {0x22889D9245104640, "DCArray<KeyframedValue<Handle<SoundReverbDefinition>>::Sample>", DCArray_KeyframedValue_Handle_SoundReverbDefinition____Sample_Read, NULL},
    ...
    {0x2531E6EFFDD55834, "T3MeshEffectPreloadEntry", T3MeshEffectPreloadEntryRead, NULL},
    {0x253CC17FE053535F, "KeyframedValue<SoundEventName<2>>", KeyframedValue_SoundEventName_2__Read, NULL},
    ...
    {0x268E0B3FC19A48AE, "int64", intrinsic8Read, s64Render},
    {0x26D936F7FF759D39, "Skeleton", SkeletonRead, NULL},
    {0x272F79595869A6EA, "KeyframedValue<Handle<WalkBoxes>>", KeyframedValue_Handle_WalkBoxes__Read, NULL},
    {0x27A5B3261A805C7E, "T3MeshBatch", T3MeshBatchRead, NULL},
    ...
    {0x28B6294866D5C910, "Handle<TransitionMap>", intrinsic8Read, SymbolRender},
    {0x2913E82ADFBF4CAD, "List<int>", NULL, NULL},
    {0x29653DC4D2D86302, "int16", intrinsic2Read, s16Render},
    ...
    {0x2B1A694F2F80DEEC, "AnimatedValueInterface<Handle<D3DMesh>>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x2E6219643954DD42, "AnimatedValueInterface<LocationInfo>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x2EFDDB0CE55AB6A6, "DCArray<KeyframedValue<bool>::Sample>", DCArray_KeyframedValue_bool___Sample_Read, NULL},
    {0x2F038E9A0FA4C428, "DlgNodeStats::DlgChildSetCohort", NULL, NULL},
    {0x2F35F13012C086E4, "AnimatedValueInterface<CompressedPathBlockingValue::CompressedPathInfoKey>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x2FE13A670E3B9412, "AnimatedValueInterface<Handle<SoundEventSnapshotData>>", AnimatedValueInterfaceGenericRead, NULL},
    {0x3007758840388E30, "DlgNodeExit", DlgNodeExitRead, NULL},
    {0x3057C880E751D8C5, "Handle<Animation>", intrinsic8Read, SymbolRender},
    ...
    {0x32EA71CFB4CA38E9, "WalkBoxes", WalkBoxesRead, NULL},
    {0x32FFF7F8AAED5859, "DCArray<Handle<Rules>>", NULL, NULL},
    {0x330C2B0399D56A72, "ScriptEnum:AIAgentState", ScriptEnumRead, NULL},
    {0x336AA0370832E993, "DCArray<KeyframedValue<AnimOrChore>::Sample>", DCArray_KeyframedValue_AnimOrChore___Sample_Read, NULL},
    {0x336ADB075A965645, "Rect", NULL, NULL},
    {0x338E4BAD4D941F67, "VoiceData", NULL, NULL},
    {0x33A1F0CB9E5BBC70, "CameraSelect", NULL, NULL},
    {0x33AF1F0B2F1338FE, "EnlightenModule::EnumeDisplayQuality", intrinsic4Read, NULL},
    ...
    {0x3428AF89D69602D2, "DCArray<Ptr<ActingPalette>>", DCArray_Ptr_ActingPalette__Read, NULL},
    ...
    {0x36FFAE9C29F1BC0E, "DCArray<KeyframedValue<Handle<PhonemeTable>>::Sample>", DCArray_KeyframedValue_Handle_PhonemeTable____Sample_Read, NULL},
    ...
    {0x3B965660D71DE2A7, "DCArray<T3OcclusionMeshBatch>", DCArray_T3OcclusionMeshBatch_Read, NULL},
    {0x3BC3CB16F9AA0F31, "List<Handle<T3Texture>>", NULL, NULL},
    {0x3BE17704E64CEBDA, "LanguageRes", LanguageResRead, NULL},
    {0x3C17F9BB2C4EE061, "DCArray<KeyframedValue<Handle<WalkBoxes>>::Sample>", DCArray_KeyframedValue_Handle_WalkBoxes____Sample_Read, NULL},
    {0x3C64522734434AF4, "TetrahedralMeshData", NULL, NULL},
    {0x3C7DD6F435A58C09, "AnimatedValueInterface<Handle<SoundBusSnapshot::SnapshotSuite>>", AnimatedValueInterfaceGenericRead, NULL},
    {0x3D2DBF388BFDE0A4, "CompressedPhonemeKeys", NULL, NULL},
    {0x3D7530F2FB48C1D4, "T3MaterialStaticParameter", T3MaterialStaticParameterRead, T3MaterialStaticParameterRender},
    ...
    {0x3DE8FE133A5A0DB7, "DCArray<T3MaterialParameter>", DCArray_T3MaterialParameter_Read, NULL},
    {0x3E249E7E6F38CCE2, "T3Texture", NULL, NULL},
    {0x3E597A1F6499DBFD, "T3MeshTextureIndices", T3MeshTextureIndicesRead, T3MeshTextureIndicesRender},
    ...
    {0x3F9231D57F64F520, "Handle<Font>", intrinsic8Read, SymbolRender},
    {0x3FD6C82DBDBCA912, "RenderObjectInterface", NULL, NULL},
    {0x40E50DFBE6B6A8A7, "DlgSystemSettings", NULL, NULL},
    {0x410FD9DEAF2A7A16, "KeyframedValue<SoundEventName<1>>", KeyframedValue_SoundEventName_1__Read, NULL},
    {0x411D4FB22E6FB323, "AnimatedValueInterface<Vector4>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x4492C4CEA3C7D14D, "KeyframedValue<int>", KeyframedValue_int_Read, NULL},
    ...
    {0x45780D6E44155DCF, "KeyframedValue<Handle<SoundEventData>>", KeyframedValue_Handle_SoundEventData__Read, NULL},
    {0x45D149740D9B1DF0, "ActingPaletteGroup", ActingPaletteGroupRead, NULL},
    {0x46DE57E6E6C4DF4A, "Handle<SaveGame>", intrinsic8Read, SymbolRender},
    {0x471A8A4511F0CCA6, "Handle<WalkBoxes>", intrinsic8Read, SymbolRender},
    {0x47957E5358BA925A, "EnlightenModule::EnumeUpdateMethod", intrinsic4Read, NULL},
    {0x47DF64BF502BB7DA, "Map<Symbol,FootSteps::FootstepBank,less<Symbol>>", Map_SymbolFootSteps__FootstepBankless_Symbol__Read, NULL},
    {0x4835DE9C54850524, "Map<String,StyleGuideRef,less<String>>", NULL, NULL},
    {0x48588668F74FED9F, "UID::Owner", intrinsic4Read, s32Render},
    ...
    {0x495617D7C61A60FD, "DCArray<WalkBoxes::Tri>", DCArray_WalkBoxes__Tri_Read, NULL},
    ...
    {0x4A36C85D3C0FEF77, "AnimatedValueInterface<Handle<Dlg>>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x4BD04E27E6716EA0, "UID::Generator", intrinsic4Read, s32Render},
    {0x4C199A98E11DF819, "BitSetBase<2>", BitSetBase_2_Read, NULL},
    {0x4C19FCA5E018EBB8, "AnimatedValueInterface<unsigned__int64>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x4E0FD348B672CF78, "DCArray<KeyframedValue<Handle<SoundAmbience::AmbienceDefinition>>::Sample>", DCArray_KeyframedValue_Handle_SoundAmbience__AmbienceDefinition____Sample_Read, NULL},
    ...
    {0x4F5348AAD96B21B6, "Chore::EnumExtentsMode", intrinsic4Read, NULL},
    {0x4F6D302E7708C977, "ContainerInterface", NULL, NULL},
    {0x4FC0A74CE6DAD33E, "Handle<LocomotionDB>", intrinsic8Read, SymbolRender},
    {0x5000C70516FF6369, "amap", NULL, NULL},
    {0x5016B7228F97D967, "BlendGraph", NULL, NULL},
    {0x5035C3ACDCC297D3, "DCArray<T3MaterialRuntimeProperty>", DCArray_T3MaterialRuntimeProperty_Read, NULL},
    ...
    {0x52A09151F1C3F2C7, "Handle<T3Texture>", intrinsic8Read, SymbolRender},
    {0x533E28DB4F24152B, "EnlightenModule::EnumeQuality", intrinsic4Read, NULL},
    ...
    {0x552D6026F0D9CDD8, "AnimatedValueInterface<Transform>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x5896A6FD1866FD93, "Handle<Rules>", intrinsic8Read, SymbolRender},
    ...
    {0x59D13F814FD13B69, "CompressedSkeletonPoseKeys2", StringRead, CompressedSkeletonPoseKeys2Render},
    {0x59F6BEC43DCEDCA4, "KeyframedValue<Vector2>", KeyframedValue_Vector2_Read, NULL},
    ...
    {0x5A28394291AC4B54, "skl", SkeletonRead, NULL},
    {0x5A4EA6259BAD5C4B, "StyleGuide", StyleGuideRead, NULL},
    ...
    {0x5AA107762678E76C, "DCArray<KeyframedValue<Vector4>::Sample>", DCArray_KeyframedValue_Vector4___Sample_Read, NULL},
    {0x5AB7A3011948922B, "KeyframedValue<Handle<D3DMesh>>", KeyframedValue_Handle_D3DMesh__Read, NULL},
    {0x5B2B9A5E74916816, "SingleValue<Handle<SoundBusSnapshot::SnapshotSuite>>", NULL, NULL},
    {0x5B50C09B7CD0CCF3, "BinaryBuffer", StringRead, NULL},
    {0x5BA42D3DE8EF60AB, "AnimatedValueInterface<PhonemeKey>", AnimatedValueInterfaceGenericRead, NULL},
    {0x5C4D98899648138E, "CompressedKeys<Symbol>", NULL, NULL},
    {0x5C62C369F193C3A0, "AnimatedValueInterface<Handle<Scene>>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x606C515AC74B48C2, "EnlightenModule::EnumeAgentUsage", intrinsic4Read, s32Render},
    {0x60D71CA7E7F3D272, "RenderObject_PostMaterial", NULL, NULL},
    {0x60D8FA0B4245E96B, "EnumEmitterParticleCountType", intrinsic4Read, s32Render},
    {0x6113F397D5F03347, "SkeletonPoseValue::Sample", NULL, NULL},
    {0x61C5765C788DC9F4, "Map<int,Ptr<DialogItem>,less<int>>", NULL, NULL},
    {0x61D00957E63D7435, "Handle<VoiceData>", intrinsic8Read, SymbolRender},
    {0x620211ED1DF8D233, "CompressedKeys<Transform>", NULL, NULL},
    {0x62045DC19ADEF8FB, "Handle<ParticleProperties>", intrinsic8Read, SymbolRender},
    {0x62C9E560C8DCEC67, "Quaternion", Vector4Read, Vector4Render},
    {0x62E12E4195FD62D1, "KeyframedValue<SoundEventName<0>>", KeyframedValue_SoundEventName_0__Read, NULL},
    {0x631987AF82113CFC, "ScriptEnum:LightComposerCameraZone", ScriptEnumRead, NULL},
    {0x632FB17165B867C2, "T3OcclusionMeshData", T3OcclusionMeshDataRead, NULL},
    ...
    {0x641290F53D772AA0, "AnimatedValueInterface<Vector2>", AnimatedValueInterfaceGenericRead, NULL},
    {0x6424EE88F6D2ACEC, "T3MaterialPassData", T3MaterialPassDataRead, NULL},
    {0x644ECB516BD073C4, "look", NULL, NULL},
    {0x645625BA2CB6235F, "EnumParticleAffectorType", intrinsic4Read, s32Render},
    {0x65739F9F4ED9BCD6, "List<Color>", NULL, NULL},
    {0x65BE4D3CABB2822B, "BlendEntry", NULL, NULL},
    {0x65C0587D94DC7E70, "EnumEmitterConstraintType", intrinsic4Read, s32Render},
    {0x65C63A60CC086F5A, "PathTo", NULL, NULL},
    {0x65FCA07EBA43311B, "Map<unsignedint,Font::GlyphInfo,less<unsignedint>>", NULL, NULL},
    {0x6643AF6DCCCC81A9, "Handle<Chore>", intrinsic8Read, SymbolRender},
    {0x668DE2C55BFAB966, "Map<Symbol,DCArray<LanguageResLocal>,less<Symbol>>", NULL, NULL},
    {0x66FAE2CA87A8B228, "EnumT3DetailShadingType", intrinsic4Read, s32Render},
    {0x6708DDFD39E39EB8, "DCArray<T3MeshLocalTransformEntry>", DCArray_T3MeshLocalTransformEntry_Read, NULL},
    {0x67104C20C9691329, "KeyframedValue<Handle<Dlg>>", KeyframedValue_Handle_Dlg__Read, NULL},
    {0x673D28039395A91A, "SArray<TRange<float>,3>", SArray_TRange_float_3_Read, NULL},
    {0x673D6BC4E630EA46, "Handle<PhonemeTable>", intrinsic8Read, SymbolRender},
    {0x67600F19A2762290, "EnumMeshDebugRenderType", intrinsic4Read, s32Render},
    {0x681AF06EDA9AF05D, "DlgChildSetChoicesChildPost", DlgChildSetChoiceRead, NULL},
    {0x68CD2023740B9FB6, "Handle<SoundEventSnapshotData>", intrinsic8Read, SymbolRender},
    {0x68FCF5B6A0D4663A, "CompressedKeys<Handle<PropertySet>>", NULL, NULL},
    {0x691645DFF205619A, "BitSetBase<4>", NULL, NULL},
    {0x6917635899F0EF5B, "DCArray<KeyframedValue<Handle<Scene>>::Sample>", DCArray_KeyframedValue_Handle_Scene____Sample_Read, NULL},
    {0x69CC70C207E837F3, "EnumT3LightEnvLODBehavior", intrinsic4Read, s32Render},
    ...
    {0x6B070125830EF084, "KeyframedValue<float>", KeyframedValue_float_Read, NULL},
    ...
    {0x6F727FA52828A910, "Handle<SoundReverbDefinition>", intrinsic8Read, SymbolRender},
    ...
    {0x72D57A55D36D2C57, "KeyframedValue<String>", KeyframedValue_String_Read, NULL},
    {0x72FBCDA2FD2C6314, "anm", AnimationRead, NULL},
    {0x73AC7A77C69A13A9, "DCArray<T3MeshEffectPreloadEntry>", DCArray_T3MeshEffectPreloadEntry_Read, NULL},
    {0x73CD313F2A6634FF, "Set<String,StringCompareCaseInsensitive>", Set_StringStringCompareCaseInsensitive_Read, NULL},
    {0x73E09E0F84717F0A, "Handle<D3DMesh>", intrinsic8Read, SymbolRender},
    {0x73E6A067ABDBD2D9, "ScriptEnum:BlendTypes", ScriptEnumRead, NULL},
    {0x746B85A804E2AE3A, "Handle<ResourceGroupInfo>", intrinsic8Read, SymbolRender},
    {0x746B9BB09CE91202, "HermiteCurvePathSegment", NULL, NULL},
    {0x74959B5BA49B660E, "DCArray<T3MeshMaterial>", DCArray_T3MeshMaterial_Read, NULL},
    {0x74A5F683AFAC29ED, "EnlightenModule::EnlightenMeshSettings::AutoUVSettings", NULL, NULL},
    {0x7533FAA271BCAF4B, "AgentState", NULL, NULL},
    {0x75361C1381F026A1, "DCArray<KeyframedValue<SoundEventName<2>>::Sample>", DCArray_KeyframedValue_SoundEventName_2____Sample_Read, NULL},
    {0x75769C9923F19ECA, "SingleValue<Polar>", NULL, NULL},
    {0x75D673493AED55BC, "poiblocking", NULL, NULL},
    {0x75D9082D642E1791, "BoundingBox", BoundingBoxRead, NULL},
    {0x75E3A1B073B8BB2F, "List<HandleLock<Scene>>", NULL, NULL},
    {0x75ECF0E2FCF2E91B, "BitSetBase<6>", NULL, NULL},
    {0x762110F462C81422, "DCArray<KeyframedValue<ScriptEnum>::Sample>", DCArray_KeyframedValue_ScriptEnum___Sample_Read, NULL},
    {0x764A963C6BAC44EA, "T3MeshEffectPreloadDynamicFeatures", T3MeshEffectPreloadDynamicFeaturesRead, NULL},
    ...
    {0x773ECCCE0DD2EDAD, "EnumRenderLightmapUVGenerationType", intrinsic4Read, s32Render},
    {0x774CFA08CA715D06, "Animation", AnimationRead, NULL},
    {0x77752EC5B9F72F50, "Localization::Language", NULL, NULL},
    {0x7864EA122E854260, "HandleBase", HandleBaseRead, HandleBaseRender},
    ...
    {0x7A54490338F7688B, "EnlightenModule::EnumeInstanceType", intrinsic4Read, s32Render},
    {0x7A8562DB047D102C, "KeyframedValueInterface", NULL, NULL},
    {0x7A90614607315516, "AnimatedValueInterface<Handle<PropertySet>>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x7BC15620354C0704, "KeyframedValue<Handle<Font>>", KeyframedValue_Handle_Font__Read, NULL},
    {0x7BD8BBB0C473B1B8, "DlgNodeWait", DlgNodeWaitRead, NULL},
    {0x7C3B4835AC024C7E, "PhonemeKey", NULL, NULL},
    {0x7CACEEBCD26D075C, "int32", intrinsic4Read, s32Render},
    {0x7CBA2F7647F0AE16, "Handle<Rule>", intrinsic8Read, SymbolRender},
    {0x7CF961832ED64527, "KeyframedValue<Vector4>", KeyframedValue_Vector4_Read, NULL},
    {0x7D0AE6CA0E07BD29, "DArray<bool>", NULL, NULL},
    {0x7D5B490DEF40D9C2, "Handle<AnimOrChore>", intrinsic8Read, SymbolRender},
    {0x7DFFEEAAEC61CE08, "EnumEmitterColorType", intrinsic4Read, s32Render},
    ...
    {0x8090795CD87B5B38, "DCArray<T3MaterialStaticParameter>", DCArray_T3MaterialStaticParameter_Read, NULL},
    ...
    {0x82E3C1E7C757BBB5, "EnumT3MaterialSwizzleType", intrinsic4Read, s32Render},
    {0x83AFDE994EFEA3D9, "Handle<ActorAgentMapper>", intrinsic8Read, SymbolRender},
    {0x83F92DB3ED618AC1, "DCArray<PreloadPackage::ResourceKey>", NULL, NULL},
    {0x84283CB979D71641, "Flags", intrinsic4Read, FlagsRender},
    {0x849BD029B8FB3C04, "ActorAgentBinding", ScriptEnumRead, NULL},
    {0x852A87571E57CCF8, "Sphere", SphereRead, NULL},
    {0x853C6A11208F77EF, "DCArray<MeshSceneLightmapData::Entry>", DCArray_MeshSceneLightmapData__Entry_Read, NULL},
    {0x858C44125C5F73D9, "DCArray<KeyframedValue<Handle<SoundData>>::Sample>", DCArray_KeyframedValue_Handle_SoundData____Sample_Read, NULL},
    ...
    {0x86C465FE6C9DBC7A, "DCArray<KeyframedValue<Handle<SoundEventSnapshotData>>::Sample>", DCArray_KeyframedValue_Handle_SoundEventSnapshotData____Sample_Read, NULL},
    {0x86CB40E8A4CBC02D, "AnimatedValueInterface<Symbol>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x897A64EEBA89CB81, "EnumParticleSortMode", intrinsic4Read, s32Render},
    ...
    {0x8ACE27FDA34B2606, "Handle<SoundBusSnapshot::SnapshotSuite>", intrinsic8Read, SymbolRender},
    ...
    {0x8AEC41470104B6E7, "DCArray<KeyframedValue<SoundEventName<1>>::Sample>", DCArray_KeyframedValue_SoundEventName_1____Sample_Read, NULL},
    {0x8B1BEC7A8664079A, "aam", NULL, NULL},
    {0x8B5F43130CAB9935, "CompressedKeys<Handle<SoundBusSnapshot::SnapshotSuite>>", NULL, NULL},
    {0x8B9A601312D0C170, "AnimatedValueInterface<ScriptEnum>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x8E88FBB78405598C, "EnumPlatformType", intrinsic4Read, s32Render},
    ...
    {0x8F2D7CA196304667, "EnumEmitterSpriteAnimationType", intrinsic4Read, s32Render},
    {0x8F40C634A937DD2A, "AnimatedValueInterface<Handle<SoundEventData>>", AnimatedValueInterfaceGenericRead, NULL},
    {0x9004C5587575D6C0, "bool", intrinsic1Read, BoolRender},
    ...
    {0x9395A07A617964C9, "Handle<StyleGuide>", intrinsic8Read, SymbolRender},
    {0x9397970E4D4168B9, "ParticleProperties", NULL, NULL},
    {0x93FD7A72DFF5E058, "DCArray<LanguageLookupMap::DlgIDSet>", NULL, NULL},
    {0x94991C29CD442F79, "EnumDOFQualityLevel", intrinsic4Read, s32Render},
    {0x94C4526CF9F79AC5, "DateStamp", NULL, NULL},
    {0x94D45772A1FF48C0, "AnimatedValueInterface<T3VertexBufferSample<T3NormalSampleData,T3HeapAllocator>>", AnimatedValueInterfaceGenericRead, NULL},
    {0x95112BCCF1AFDB66, "CompressedKeys<Handle<SoundAmbience::AmbienceDefinition>>", NULL, NULL},
    {0x954B47E44A5FFA6E, "AnimatedValueInterface<bool>", AnimatedValueInterfaceGenericRead, NULL},
    {0x954F8FF8B3F40B36, "reverb", NULL, NULL},
    {0x95A97D3178992D3C, "Map<Symbol,Localization::Language,less<Symbol>>", NULL, NULL},
    {0x96214C23CC241657, "Handle<StyleGuideRef>", intrinsic8Read, SymbolRender},
    {0x9646F3B778897027, "AnimatedValueInterface<SoundEventName<0>>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0x995FC5C3CB87E5F8, "PhysicsObject::EnumePhysicsBoundingVolumeType", intrinsic4Read, s32Render},
    {0x998E73C393F6A122, "PhonemeTable::PhonemeEntry", PhonemeTable__PhonemeEntryRead, NULL},
    {0x99B7E7B82012690C, "EnlightenModule::EnumeProbeResolution", intrinsic4Read, s32Render},
    {0x99D7C52EA7F0F97D, "int", intrinsic4Read, s32Render},
    ...
    {0x9B20C35CA1E12BD5, "EnumRenderAntialiasType", intrinsic4Read, s32Render},
    ...
    {0x9B52B73BB2BFE113, "DCArray<T3MeshLOD>", DCArray_T3MeshLOD_Read, NULL},
    ...
    {0x9D52A3E9C5186D6F, "EnumBokehQualityLevel", intrinsic4Read, s32Render},
    ...
    {0x9EE5E31EF2F71F0E, "Handle<Scene>", intrinsic8Read, SymbolRender},
    ...
    {0xA000ECC5490A2A94, "EnumT3LightEnvMobility", intrinsic4Read, s32Render},
    ...
    {0xA14B12F2880C71F0, "Handle<PreloadPackage::RuntimeDataDialog>", intrinsic8Read, SymbolRender},
    {0xA1975655F1C71142, "DCArray<Handle<Scene>>", NULL, NULL},
    {0xA1B5E14F4AF83C27, "T3GFXBuffer", T3GFXBufferRead, T3GFXBufferRender},
    {0xA2048C57716AD85F, "DCArray<T3Texture>", NULL, NULL},
    {0xA2435650D27ACF90, "EnlightenModule::EnumeSceneOptimisationMode", intrinsic4Read, s32Render},
    {0xA33B55750C7BF243, "Map<int,int,less<int>>", NULL, NULL},
    {0xA34E655ED1345F8B, "WalkAnimator", NULL, NULL},
    {0xA35C247B710DFF99, "DCArray<KeyframedValue<Handle<PropertySet>>::Sample>", DCArray_KeyframedValue_Handle_PropertySet____Sample_Read, NULL},
    {0xA36BC2EB0A5B26AF, "ProceduralEyes", NULL, NULL},
    {0xA3A998B26DBC4FBB, "DCArray<ResourceBundle::ResourceInfo>", NULL, NULL},
    {0xA406267E2A2F22D9, "T3MeshBoneEntry", T3MeshBoneEntryRead, NULL},
    {0xA47918A7D3C3A67A, "Handle<PhysicsObject>", intrinsic8Read, SymbolRender},
    ...
    {0xA62FE74CCFA3467C, "EnlightenModule::EnumeDistributedBuildSystem", intrinsic4Read, s32Render},
    {0xA6E64DD3378991B4, "SoundAmbience::AmbienceDefinition", NULL, NULL},
    {0xA7152CED90755212, "DlgFolder", DlgFolderRead, NULL},
    {0xA7353268AC8AAD1F, "DCArray<T3MaterialCompiledData>", DCArray_T3MaterialCompiledData_Read, NULL},
    {0xA7A8C91070E4C52E, "DCArray<ParticleSprite::Animation>", DCArray_ParticleSprite__Animation_Read, NULL},
    {0xA7DAAA296D1491CC, "DCArray<T3MeshTexture>", DCArray_T3MeshTexture_Read, NULL},
    {0xA7FE20E35345AC33, "DlgLine", DlgLineRead, NULL},
    {0xA877237AFCDAAA59, "KeyframedValue<Handle<PropertySet>>", KeyframedValue_Handle_PropertySet__Read, NULL},
    {0xA8C7AA1469C78EA2, "List<List<Symbol>>", NULL, NULL},
    {0xA8E93E14BF58645C, "DCArray<Ptr<ActingAccentPalette>>", DCArray_Ptr_ActingAccentPalette__Read, NULL},
    {0xA8F90B07ADEFAB41, "short", intrinsic2Read, NULL},
    {0xA96424E7FCCBF8EB, "EnumT3LightEnvBakeOnStatic", intrinsic4Read, s32Render},
    {0xA98EAE8F6CFF1125, "Map<String,LogicGroup::LogicItem,less<String>>", Map_StringLogicGroup__LogicItemless_String__Read, NULL},
    {0xA98F0652295DE685, "EnumT3MaterialLightModelType", intrinsic4Read, s32Render},
    ...
    {0xAB04CC2F75BCF6C0, "DCArray<Ptr<ActingPaletteGroup>>", DCArray_Ptr_ActingPaletteGroup__Read, NULL},
    ...
    {0xABD836B706872262, "Handle<DialogResource>", intrinsic8Read, SymbolRender},
    {0xAC389286CDE5A182, "Map<Symbol,SoundBankWaveMapEntry,less<Symbol>>", Map_SymbolSoundBankWaveMapEntryless_Symbol__Read, NULL},
    {0xAD15A7FE0904AE6A, "EnumT3LightEnvGroup", intrinsic4Read, s32Render},
    ...
    {0xAFB5DB7305E23480, "int8", intrinsic1Read, s8Render},
    {0xB02BC4AD45C96F0E, "FootSteps", NULL, NULL},
    {0xB038C6742811D7FA, "DCArray<CorrespondencePoint>", NULL, NULL},
    {0xB03A4E300519F2C1, "__int64", intrinsic8Read, s64Render},
    {0xB056BCD869E07B38, "DCArray<KeyframedValue<Handle<SoundEventData>>::Sample>", DCArray_KeyframedValue_Handle_SoundEventData____Sample_Read, NULL},
    {0xB060A66E8CD67299, "DCArray<SklNodeData>", NULL, NULL},
    {0xB0F644BC42B51B0B, "KeyframedValue<Handle<Scene>>", KeyframedValue_Handle_Scene__Read, NULL},
    ...
    {0xB64F1AE3E7BBC58F, "EnlightenModule::EnumeQualityWithDefault", intrinsic4Read, s32Render},
    ...
    {0xB72556399FBC3C04, "AnimatedValueInterface<T3VertexBufferSample<T3PositionSampleData,T3HeapAllocator>>", AnimatedValueInterfaceGenericRead, NULL},
    {0xB76962276766EA0A, "PathSegment", NULL, NULL},
    {0xB76E07D6BB899BFE, "Vector4", Vector4Read, Vector4Render},
    {0xB76E52C699301BDA, "DCArray<T3MaterialTextureParam>", DCArray_T3MaterialTextureParam_Read, NULL},
    {0xB876B4CEF80F1EDB, "DCArray<ActingPaletteClass>", DCArray_ActingPaletteClass_Read, NULL},
    {0xB8AC7017234E9F78, "ResourceGroupInfo", NULL, NULL},
    {0xB930FF00A4687C7E, "Handle<InputMapper>", intrinsic8Read, SymbolRender},
    {0xBA2A9CC6D78EDEA8, "SingleValue<Handle<SoundEventSnapshotData>>", NULL, NULL},
    {0xBA4781F930BE11F7, "DCArray<KeyframedValue<Handle<SoundBusSnapshot::SnapshotSuite>>::Sample>", DCArray_KeyframedValue_Handle_SoundBusSnapshot__SnapshotSuite____Sample_Read, NULL},
    {0xBA6CABFE529F5849, "DCArray<InputMapper::EventMapping>", NULL, NULL},
    {0xBABC2FCF7E7B70AA, "style", StyleGuideRead, NULL},
    {0xBABC2FCF7E7B70AA, "Style", StyleGuideRead, NULL},
    {0xBAE4CBD77F139A91, "float", intrinsic4Read, FloatRender},
    {0xBAF342C1FC31C370, "T3GFXVertexState", T3GFXVertexStateRead, NULL},
    {0xBB01AD6EFE5EE662, "List<T3ToonGradientRegion>", NULL, NULL},
    {0xBB03444E2D5051F5, "KeyframedValue<Handle<SoundBusSnapshot::Snapshot>>", KeyframedValue_Handle_SoundBusSnapshot__Snapshot__Read, NULL},
    {0xBB0D8C38D7C34967, "SingleValue<T3VertexBufferSample<T3NormalSampleData,T3HeapAllocator>>", NULL, NULL},
    {0xBB6BAD6A055D7EDB, "EnlightenModule::EnumeAutoUVSimplificationMode", intrinsic4Read, s32Render},
    ...
    {0xBDEBB69D2C134E45, "EnumT3NPRSpecularType", intrinsic4Read, s32Render},
    {0xBE12CAA65204CDE4, "DCArray<KeyframedValue<Handle<Dlg>>::Sample>", DCArray_KeyframedValue_Handle_Dlg____Sample_Read, NULL},
    ...
    {0xC04ED0CBAF7D9C90, "EnumGlowQualityLevel", intrinsic4Read, s32Render},
    {0xC07A4D6DA8CD0B6C, "Handle<BlendGraphManager>", intrinsic8Read, SymbolRender},
    {0xC09A0F1FEE902C1A, "CSPK2Context", NULL, NULL},
    {0xC0B682D7D515ED83, "Handle<SoundEventBankDummy>", intrinsic8Read, SymbolRender},
    {0xC0E90B6129B2DADA, "CompressedKeys<bool>", NULL, NULL},
    {0xC16762F7763D62AB, "Color", Vector4Read, ColorRender},
    {0xC1E4AC327DAD6D1C, "bgh", NULL, NULL},
    {0xC2254DAAD52E7340, "Handle<PhysicsData>", intrinsic8Read, SymbolRender},
    {0xC23697BBFB06DD17, "Handle<LanguageResource>", intrinsic8Read, SymbolRender},
    ...
    {0xC561A117A7710B6A, "T3MaterialPreShader", T3MaterialPreShaderRead, T3MaterialPreShaderRender},
    {0xC5C3044FA9C1D61F, "CompressedKeys<Handle<SoundEventData>>", NULL, NULL},
    {0xC604C9307F8A6EB1, "AnimatedValueInterface<Handle<PhonemeTable>>", AnimatedValueInterfaceGenericRead, NULL},
    {0xC6136FB4A18BBE93, "BitSetBase<5>", NULL, NULL},
    {0xC61768F8C7376559, "Handle<SoundBusSnapshot::Snapshot>", intrinsic8Read, SymbolRender},
    ...
    {0xC96C8DBBBEA1DEAB, "EnumTextOrientationType", intrinsic4Read, s32Render},
    {0xC995828AC3B803F2, "DCArray<Skeleton::Entry>", DCArray_Skeleton__Entry_Read, NULL},
    {0xC9CA51C8795945F0, "DCArray<WalkBoxes::Vert>", DCArray_WalkBoxes__Vert_Read, NULL},
    {0xCA26CD88FAD4EF7E, "EnlightenModule::EnlightenLightSettings", NULL, NULL},
    {0xCA272B9CDA05B750, "bgm", NULL, NULL},
    {0xCA874E09192E2598, "AnimatedValueInterface<Color>", AnimatedValueInterfaceGenericRead, NULL},
    {0xCB029403B12D08D6, "unsignedint", intrinsic4Read, u32Render},
    {0xCB17BA9E6EF9F5A9, "AnimatedValueInterface<Vector3>", AnimatedValueInterfaceGenericRead, NULL},
    {0xCB31FAC32D7FAD8D, "eyes", NULL, NULL},
    {0xCB39F1559069B3BA, "wav", NULL, NULL},
    {0xCB9B7B7C2D2A90E7, "EnumT3LightEnvEnlightenBakeBehavior", intrinsic4Read, s32Render},
    {0xCBF0AB8D9CB98AEF, "DCArray<KeyframedValue<float>::Sample>", DCArray_KeyframedValue_float___Sample_Read, NULL},
    {0xCBFD53673C25ECC0, "EnumHTextAlignmentType", intrinsic4Read, s32Render},
    {0xCC77A061EBC3ABED, "AudioData", NULL, NULL},
    {0xCCDF9AEC974E91FC, "CompressedKeys<Handle<WalkBoxes>>", NULL, NULL},
    {0xCCE2FC8ABD78A775, "EnlightenModule::EnumeProbeResolutionWithDefault", intrinsic4Read, s32Render},
    {0xCD75DC4F6B9F15D2, "PropertySet", PropRead, NULL},
    {0xCD9B448F1003E791, "KeyframedValue<Color>", NULL, NULL},
    {0xCD9C6E605F5AF4B4, "String", StringRead, StringRender},
    {0xCDA6183D330B433B, "ChoreInst", NULL, NULL},
    {0xCDD094E2E769C2B5, "ToolProps", intrinsic1Read, BoolRender},
    ...
    {0xCF8A73B34BC665CC, "AnimatedValueInterface<AnimOrChore>", AnimatedValueInterfaceGenericRead, NULL},
    {0xCFAF2019AB83376A, "KeyframedValue<Handle<SoundAmbience::AmbienceDefinition>>", KeyframedValue_Handle_SoundAmbience__AmbienceDefinition__Read, NULL},
    ...
    {0xD0B8814E41A8A279, "DCArray<KeyframedValue<Symbol>::Sample>", DCArray_KeyframedValue_Symbol___Sample_Read, NULL},
    {0xD0E7D2AFB7D9C68B, "DlgNodeText", DlgNodeTextRead, NULL},
    {0xD170386D6E88C1AF, "T3LightEnvLOD", intrinsic4Read, s32Render},
    {0xD19B1C890D2741A9, "AnimatedValueInterface<SoundEventName<2>>", AnimatedValueInterfaceGenericRead, NULL},
    {0xD1C9280F82A39E78, "SingleValue<Handle<T3Texture>>", NULL, NULL},
    {0xD1EF776F1BEFCA35, "ActingPaletteClass", ActingPaletteClassRead, NULL},
    ...
    {0xD2E7CDB2B4266AE2, "DCArray<HandleBase>", DCArray_HandleBase_Read, NULL},
    {0xD388A4AFB51DB41C, "AnimatedValueInterface<Handle<WalkBoxes>>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0xD521915AA8E8C0F7, "DCArray<KeyframedValue<Handle<T3Texture>>::Sample>", DCArray_KeyframedValue_Handle_T3Texture____Sample_Read, NULL},
    {0xD5C86012BF6B91CA, "LanguageResProxy", intrinsic4Read, s32Render},
    {0xD5D35E216D0124D6, "Dlg", DlgRead, NULL},
    {0xD5D35E216D0124D6, "dlg", NULL, NULL},
    {0xD6652FB7B143EA32, "AutoActStatus", intrinsic4Read, NULL},
    {0xD6A50A09FEA7E4A6, "DCArray<KeyframedValue<Vector3>::Sample>", DCArray_KeyframedValue_Vector3___Sample_Read, NULL},
    ...
    {0xD7CE90BB8FFA4753, "EnumT3MaterialNormalSpaceType", intrinsic4Read, s32Render},
    ...
    {0xD992E1D329469995, "DCArray<KeyframedValue<int>::Sample>", DCArray_KeyframedValue_int___Sample_Read, NULL},
    {0xD9E5E39D06F0A6E3, "List<bool>", NULL, NULL},
    {0xDA31784DA793EAA2, "KeyframedValue<Handle<SoundEventSnapshotData>>", KeyframedValue_Handle_SoundEventSnapshotData__Read, NULL},
    {0xDA3D01BDBECEDE15, "KeyframedValue<PhonemeKey>", NULL, NULL},
    {0xDAC65150E4EE6266, "EnlightenModule::EnumeRadiositySampleRate", intrinsic4Read, s32Render},
    {0xDAE9DA89AF7C3612, "BitSetBase<7>", NULL, NULL},
    {0xDBD3D5D932FEA4DA, "MovieCaptureInfo::EnumCompressorType", NULL, NULL},
    {0xDC03A83314ADFC51, "Handle<BlendGraph>", intrinsic8Read, SymbolRender},
    {0xDCD169E0C98FE760, "T3MaterialTransform2D", T3MaterialTransform2DRead, NULL},
    {0xDDADACE79FB1DDF0, "EnumHBAOParticipationType", intrinsic4Read, s32Render},
    {0xDDB5965209539B0E, "snapshotsuite", NULL, NULL},
    {0xDDE3A9E749A30518, "unsigned__int64", intrinsic8Read, u64Render},
    {0xDE877F4252845725, "probe", NULL, NULL},
    {0xDE9FEE749B0ED110, "EnumRenderMaskWrite", intrinsic4Read, s32Render},
    {0xDF2C74713A04DDA7, "Handle<SoundData>", intrinsic8Read, SymbolRender},
    {0xDF302FFF123E7CAB, "T3MaterialParameter", T3MaterialParameterRead, T3MaterialStaticParameterRender},
    {0xDF30362E292BEF14, "CompressedKeys<Color>", NULL, NULL},
    {0xDFA5071C13D73E63, "Handle<AgentMap>", intrinsic8Read, SymbolRender},
    ...
    {0xE0F187F2BB24DD1F, "T3MaterialTexture", T3MaterialTextureRead, NULL},
    {0xE0FDB8250AD3923D, "AnimatedValueInterface<String>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0xE31CB0F3B2932710, "BitSetBase<3>", BitSetBase_3_Read, NULL},
    ...
    {0xE3BC39514745D2DE, "Map<SoundFootsteps::EnumMaterial,DCArray<Handle<SoundData>>,less<SoundFootsteps::EnumMaterial>>", Map_SoundFootsteps__EnumMaterialDCArray_Handle_SoundData__less_SoundFootsteps__EnumMaterial__Read, NULL},
    {0xE4510BD515264FE5, "langdb", NULL, NULL},
    {0xE494D922BF9DFB44, "T3ToonGradientRegion", NULL, NULL},
    {0xE4E5A2E3EC044937, "DCArray<KeyframedValue<String>::Sample>", DCArray_KeyframedValue_String___Sample_Read, NULL},
    ...
    {0xE7D7C131B05A9D80, "AnimatedValueInterface<Handle<SoundData>>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0xEA086C95C87CA185, "EnlightenModule::EnlightenPrimitiveSettings", EnlightenModule__EnlightenPrimitiveSettingsRead, NULL},
    {0xEA20A667D4C75946, "EnumBokehOcclusionType", intrinsic4Read, s32Render},
    ...
    {0xEB48981A297A46B7, "KeyframedValue<Handle<SoundReverbDefinition>>", KeyframedValue_Handle_SoundReverbDefinition__Read, NULL},
    {0xEB7FE6D415249768, "Handle<PreloadPackage::RuntimeDataScene>", intrinsic8Read, SymbolRender},
    ...
    {0xEE65A936C01E9C9A, "KeyframedValue<Handle<PhonemeTable>>", KeyframedValue_Handle_PhonemeTable__Read, NULL},
    {0xEEF01208F0F466CD, "AnimatedValueInterface<Handle<Chore>>", AnimatedValueInterfaceGenericRead, NULL},
    ...
    {0xF0205400D4C83EBC, "TRange<float>", Vector2Read, Vector2Render},
    {0xF07C552824816DD1, "char", intrinsic1Read, NULL},
    {0xF07D50698E252C35, "ldb", NULL, NULL},
    {0xF0CA92E85C1E9849, "KeyframedValue<Handle<T3Texture>>", KeyframedValue_Handle_T3Texture__Read, NULL},
    {0xF17A1008ADE9BDCD, "EnumDepthOfFieldType", intrinsic4Read, s32Render},
    {0xF195067C56F55DD3, "DCArray<WalkBoxes::Quad>", DCArray_WalkBoxes__Quad_Read, NULL},
    ...
    {0xF3E07C3D67895FD1, "DCArray<T3MeshBatch>", DCArray_T3MeshBatch_Read, NULL},
    {0xF47250AB93E98778, "Rollover", NULL, NULL},
    {0xF47CD36D533ECCB5, "DCArray<KeyframedValue<Quaternion>::Sample>", DCArray_KeyframedValue_Quaternion___Sample_Read, NULL},
    {0xF496A008F1E15BA5, "EnumHBAOPreset", intrinsic4Read, s32Render},
    ...
    {0xF6792A98BDA977A7, "EnumLightCellBlendMode", intrinsic4Read, s32Render},
    {0xF6D4C230B74B44FD, "DlgConditionTime", DlgConditionTimeRead, NULL},
    {0xF6F394AF6E4003AD, "KeyframedValue<Vector3>", KeyframedValue_Vector3_Read, NULL},
    {0xF70A9218630D4FF4, "DCArray<Handle<SoundData>>", DCArray_Handle_SoundData__Read, NULL},
    ...
    {0xF7FA917047267F56, "EnumVTextAlignmentType", intrinsic4Read, s32Render},
    ...
    {0xFA7FC6889D2A5CFC, "ParticleLODKey", Vector4Read, Vector4Render},
    {0xFAD2B7D432F6E393, "EnumHBAOPerPixelNormals", intrinsic4Read, s32Render},
    ...
    {0xFBC46015AD30C413, "DCArray<KeyframedValue<Handle<D3DMesh>>::Sample>", DCArray_KeyframedValue_Handle_D3DMesh____Sample_Read, NULL},
    ...
    {0xFC96DFDEDE31FB4A, "unsignedlong", intrinsic4Read, u32Render},
    ...
    {0xFF38D8541F524A49, "ActingOverridablePropOwner", ActingOverridablePropOwnerRead, NULL},
    {0xFF5781EF90514A8C, "ClipResourceFilter", NULL, NULL},
    {0xFFA2F0E137146530, "Scene::AgentQualitySettings", NULL, NULL},
    {0xFFE605CEBC64AF91, "BitSetBase<1>", BitSetBase_1_Read, NULL},
    {0xFFEA794BCAFBF983, "SoundSystem::Implementation::ChannelHolder", NULL, NULL},
    {0xFFECC5B70AD06BE6, "PhysicsObject::EnumePhysicsCollisionType", intrinsic4Read, s32Render},
};
